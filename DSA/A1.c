...
//         scanf("%d",&a[i]);
//     }
//     printf("1 to insert, 2 to delete, 3 to search and 4 to display and 5 to
//     replace"); scanf("%d",&j); switch (j)
//     {
//     case 1:
//         int tar,pos;
...
void replace(int a[], int target, int pos) { a[pos] = target; }
...
void main() {
  ...
  printf("Enter 1 to insert, 2 to delete, 3 to replace, 4 to search and 5 to "
         "display the array");
  scanf("%d", &j);
  switch (j) {
  case 1:
